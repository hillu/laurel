...
mod test {
    ...
    fn parse_syslog() -> Result<(), SocketAddrError> {
        ...
        assert_eq!(
            SocketAddr::parse(&b""[..]).unwrap(),
        ...
        assert_eq!(
            ...
            .unwrap(),
            SocketAddr::Inet("0.0.0.0:55555".parse::<SocketAddrV4>().unwrap())
        );
